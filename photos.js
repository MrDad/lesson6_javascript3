...
function createEventListeners() {
   ...
   //declare variable for document element with id of right arrow, which is in the html document
   var rightarrow = document.getElementById("rightarrow");
   //add an event handler to the specified document element (right arrow)
